    ...
    <>
      <div className="min-h-screen bg-background flex flex-col justify-center lg:justify-start">
        <div className="container mx-auto px-4 py-4 sm:py-8">
          ...
          {/* Progress Steps */}
          <div className="mb-8">
            <div className="flex items-center justify-center space-x-1 md:space-x-16 ">
                  ...
                  <CardContent>
                    ...
                    <div className="flex justify-between pt-6">
                      <Button
                        ...
                        className="btn-hover-scale bg-transparent"
                      >
                        Back to Shipping
                      </Button>
                      {paymentMethod === "cod" && (
              ...
              <Card className="sticky top-24">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      <span>Handelling charges</span>
                      <span>
                        {deliveryFee === 0
                          ? "FREE"
                          : `₹${Math.floor(deliveryFee / 3)}`}
                      </span>
                    </div>
                    <Separator />
                    <div className="flex justify-between font-semibold">
                      ...
                      <span className="text-primary">
                        ...
                        {deliveryFee === 0
                          ? finalTotal
                          : finalTotal + Math.floor(deliveryFee / 3)}
                      </span>
                    </div>
